...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        'display': ['48px', { lineHeight: '1.06', letterSpacing: '-1.5px', fontWeight: '800' }],
        'h1': ['40px', { lineHeight: '1.10', letterSpacing: '-1px', fontWeight: '800' }],
        'h2': ['34px', { lineHeight: '1.12', letterSpacing: '-0.5px', fontWeight: '700' }],
        'h3': ['28px', { lineHeight: '1.14', letterSpacing: '-0.3px', fontWeight: '700' }],
        'h4': ['22px', { lineHeight: '1.18', fontWeight: '600' }],
        'h5': ['20px', { lineHeight: '1.20', fontWeight: '600' }],
        'body-lg': ['17px', { lineHeight: '1.29', fontWeight: '400' }],
        'body': ['15px', { lineHeight: '1.33', fontWeight: '400' }],
        'body-sm': ['13px', { lineHeight: '1.38', fontWeight: '400' }],
        'caption': ['11px', { lineHeight: '1.27', fontWeight: '400' }],
        'label': ['11px', { lineHeight: '1.27', letterSpacing: '0.06em', fontWeight: '600' }],
