        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-20">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
              ...
              <motion.div variants={reveal} custom={3} className="grid grid-cols-4 gap-6 mb-5">
                {insuranceLogos.map((c, i) => (
                  <motion.div
                    key={c.name}
                    whileHover={{ scale: 1.08, y: -3 }}
                    className="flex items-center justify-center h-14 grayscale hover:grayscale-0 opacity-70 hover:opacity-100 transition-all duration-400"
                  >
