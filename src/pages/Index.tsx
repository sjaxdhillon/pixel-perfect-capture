  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section ref={heroRef} className="bg-brand-navy relative min-h-[90vh] flex items-center overflow-hidden">
        {/* Subtle gradient orb - not a generic slop orb, a controlled brand-blue wash */}
          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-0 items-center min-h-[80vh]">
            ...
            <motion.div initial="hidden" animate="visible" className="lg:col-span-6 relative z-10 lg:pr-12">
              ...
              >
                Delivering
                <br />
                <span className="text-brand-blue">Smiles</span> Across
                <br />
                Las Vegas Valley
              </motion.h1>
              ...
              <motion.p variants={reveal} custom={3} className="font-body text-[16px] text-navy-100 mb-10 max-w-md leading-relaxed">
                No corporate fluff, no upselling. Just real, high-quality dental care for you and your family — open evenings and weekends.
              </motion.p>
      ...
      <section className="py-24 md:py-32 bg-brand-navy relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }}>
            ...
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mt-3 mb-12">
              ...
              <motion.div variants={reveal} custom={2} className="flex flex-wrap gap-2">
          ...
          >
            {filteredServices.map((s, i) => (
              <div key={s.id} className="bg-white/6 backdrop-blur-sm border border-white/8 rounded-2xl p-6 hover:bg-white/10 hover:border-white/15 transition-all duration-300 group cursor-pointer">
        ...
        <div className="container mx-auto px-4">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
            ...
            <motion.h2 variants={reveal} custom={1} className="font-display text-[clamp(28px,4vw,44px)] font-extrabold text-brand-navy mt-3 mb-4 leading-[1.1] tracking-tight">
              Affordable Care, Just for You
            </motion.h2>
            <motion.p variants={reveal} custom={2} className="font-body text-[16px] text-brand-slate mb-14 max-w-lg">
              We believe great dental care shouldn't break the bank. Here are our current specials.
            </motion.p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
              ...
              <motion.p variants={reveal} custom={2} className="font-body text-[15px] text-brand-slate mb-8 leading-relaxed">
                We're in-network with most major PPO plans, including Medicare. Don't see yours? Call us — we'll check your benefits for free.
              </motion.p>
              <motion.div variants={reveal} custom={3} className="flex flex-wrap gap-2 mb-8">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
              ...
              {[
                { name: "Sunbit", desc: "Apply in 30 seconds. Up to $20K. No hard credit check. 90% approval rate." },
      ...
      <section className="bg-blue-50 py-24 md:py-32">
        <div className="container mx-auto px-4">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} className="grid md:grid-cols-3 gap-4">
            {[
              { city: "Las Vegas", count: 13, areas: "Summerlin · Blue Diamond · Skye Canyon · Fort Apache · Charleston", color: "bg-brand-blue" },
              { city: "Henderson", count: 7, areas: "Cadence · Inspirada · St. Rose · Boulder Hwy · Lake Mead", color: "bg-brand-teal" },
              { city: "North Las Vegas", count: 3, areas: "North 5th · Revere · Sedona Ranch", color: "bg-navy-400" },
            ].map((loc, i) => (
              <motion.div
                key={loc.city}
                variants={reveal}
                custom={i}
                className="bg-white rounded-2xl p-6 border border-blue-50 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group cursor-pointer"
              >
