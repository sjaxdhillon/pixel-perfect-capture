...
const EmergencyDentalCare = () => (
  <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 pt-20 pb-20 md:pt-28 md:pb-28 relative z-10">
        <motion.div initial="hidden" animate="visible" className="max-w-2xl">
          <motion.div variants={reveal} custom={0} className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm rounded-btn px-4 py-2 mb-6">
            ...
            <span className="font-display font-semibold text-[11px] uppercase tracking-[0.1em] text-white">Same-Day Appointments Available</span>
          </motion.div>
          ...
          <motion.p variants={reveal} custom={2} className="font-body text-[clamp(16px,1.8vw,20px)] text-coral-50 leading-relaxed mb-8 max-w-xl">
          ...
          <motion.div variants={reveal} custom={3} className="inline-flex items-baseline gap-3 bg-white/12 backdrop-blur-sm rounded-2xl px-6 py-4 mb-10">
            <span className="font-display font-extrabold text-[48px] text-white leading-none">$49</span>
            <div>
              <span className="font-display font-bold text-[15px] text-white block">Emergency Exam & X-Ray</span>
              <span className="font-body text-[13px] text-coral-100 line-through">reg. $155</span>
            </div>
          </motion.div>
    ...
    <section className="py-24 md:py-32">
      <div className="container mx-auto px-4">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
          <motion.span variants={reveal} custom={0} className="font-display font-bold text-[11px] uppercase tracking-[0.12em] text-brand-coral">Dental Emergencies</motion.span>
        ...
        <div className="grid lg:grid-cols-5 gap-10 items-start">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} className="lg:col-span-3">
            <p className="font-body text-[16px] text-brand-slate mb-8 leading-relaxed max-w-lg">
          ...
          >
            <motion.div variants={reveal} custom={0} className="bg-brand-coral rounded-3xl p-8 md:p-10 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h3 className="font-display font-bold text-[20px] text-white mt-3 mb-3 leading-tight">
                ...
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <p className="font-body text-[14px] text-coral-50 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {processSteps.map((step, i) => (
              <motion.div key={i} variants={reveal} custom={i} className="bg-white rounded-3xl p-7 border border-blue-50 relative group hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                <span className="font-display font-extrabold text-[52px] text-blue-50 leading-none select-none absolute top-4 right-5 group-hover:text-coral-50 transition-colors">
                  {String(i + 1).padStart(2, "0")}
                </span>
                <div className="w-10 h-10 rounded-2xl bg-coral-50 flex items-center justify-center mb-5">
                  <span className="font-display font-extrabold text-[16px] text-brand-coral">{i + 1}</span>
                </div>
    ...
    <section className="py-24 md:py-32">
      <div className="container mx-auto px-4">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
          <motion.span variants={reveal} custom={0} className="font-display font-bold text-[11px] uppercase tracking-[0.12em] text-brand-coral">No Surprises</motion.span>
          <motion.h2 variants={reveal} custom={1} className="font-display text-[clamp(28px,4vw,44px)] font-extrabold text-brand-navy mt-3 mb-14 leading-[1.1] tracking-tight">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} className="grid lg:grid-cols-2 gap-6">
          ...
          <motion.div variants={reveal} custom={0} className="bg-brand-coral rounded-3xl p-8 md:p-10 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <span className="inline-block font-display font-bold text-[11px] uppercase tracking-wider text-coral-100 bg-white/10 px-3 py-1 rounded-btn mb-5">Most Popular</span>
              <div className="flex items-baseline gap-3 mb-2">
                <span className="font-display font-extrabold text-[56px] text-white leading-none">$49</span>
                <span className="font-body text-[15px] text-coral-100 line-through">$155</span>
              </div>
              <h3 className="font-display font-bold text-[22px] text-white mb-3">Emergency Exam & X-Ray</h3>
              <p className="font-body text-[15px] text-coral-50 leading-relaxed mb-6">
              ...
              <div className="space-y-3 mb-8">
                {["Full emergency exam & digital X-rays", "Same-day pain relief treatment", "FREE comprehensive exam within 30 days ($380 value)", "Insurance verification included"].map((item) => (
                  <div key={item} className="flex items-start gap-2.5">
                    ...
                    <span className="font-body text-[14px] text-coral-50">{item}</span>
                  </div>
                ))}
              </div>
              <a href="tel:+17028522829">
          ...
          <div className="space-y-5">
            <motion.div variants={reveal} custom={1} className="bg-blue-50 rounded-3xl p-8 border border-blue-100">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="font-display font-bold text-[18px] text-brand-navy">Insurance Friendly</h4>
              </div>
              <p className="font-body text-[15px] text-brand-slate leading-relaxed mb-4">
            ...
            <motion.div variants={reveal} custom={2} className="bg-gold-50 rounded-3xl p-8 border border-gold-100">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-2xl bg-brand-gold/15 flex items-center justify-center">
                  <span className="font-display font-extrabold text-[16px] text-gold-600">$0</span>
                </div>
                <h4 className="font-display font-bold text-[18px] text-brand-navy">No Insurance? No Problem.</h4>
              </div>
              <p className="font-body text-[15px] text-brand-slate leading-relaxed mb-2">
    ...
    <section className="py-24 md:py-32">
      <div className="container mx-auto px-4 max-w-3xl">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
          <motion.span variants={reveal} custom={0} className="font-display font-bold text-[11px] uppercase tracking-[0.12em] text-brand-coral">FAQ</motion.span>
